...
const otherHomeBanner = require("../../assets/images/astrology.png");
const homeBanner = require("../../assets/images/astrology.png");
...
export default function Home() {
  ...
  const getHomeData = async () => {
    const res = await fetch(
      `http://65.0.52.105:8006/api/resource/Screen/661fgqspd1?sid=${sid}`,
      {
        method: "GET",
        headers: {
  ...
  return (
    <View style={homeStyles.mainContainer}>
      ...
      >
        ...
        <Text style={homeStyles.astrologersText}>Astrologers</Text>
        <ScrollView
          horizontal
        ...
        <Text style={homeStyles.astrologersText}>Latest from Blog</Text>
        <ScrollView
          horizontal
          style={homeStyles.scrollContainer}
          showsHorizontalScrollIndicator={false}
